---
title: defineFixture
description: Author a typed test/dev fixture — seed data plus the plugins it depends on.
---
...
The same fixture object, unchanged — `defineFixture` is an identity function that exists purely to attach types and
