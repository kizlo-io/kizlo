...
description: Wire Kizlo into a TanStack Start (React) app and make your first call.
---
...
finishes, `cd my-app`. Building with Solid instead? See the [TanStack Start (Solid)](/docs/quickstarts/tanstack-start/solid) quickstart.
