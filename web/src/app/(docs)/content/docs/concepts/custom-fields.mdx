...
Regenerate `wordpress.ts` after updating the Kizlo plugins or changing custom-field settings. See the
[WordPress client](/docs/concepts/wordpress-client#generate-the-client) for generation and commit guidance.
