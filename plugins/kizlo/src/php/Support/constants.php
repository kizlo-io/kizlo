 ...
 * Settings page slug.
 */
define('KIZLO_SETTINGS_PAGE', 'kizlo');
...
define('KIZLO_OPTION_HOME_SEO_OG_IMAGE_ALT',   'kizlo_home_seo_og_image_alt');
define('KIZLO_OPTION_HOME_SEO_DATE_PUBLISHED', 'kizlo_home_seo_date_published');
define('KIZLO_OPTION_HOME_SEO_DATE_MODIFIED',  'kizlo_home_seo_date_modified');
