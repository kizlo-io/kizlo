...
final class DeletedSchema
{
    ...
    /**
     * What a collection delete answers with.
     *
     * There is no single record to hand back, so core reports how many it
     * removed. `WP_REST_Application_Passwords_Controller::delete_items()` is the
    ...
    public static function counted(): array
    {
        return [
            ...
            'properties' => [
                ...
                'count'   => ['type' => 'integer', 'required' => true, 'description' => 'How many records were deleted.'],
            ],
        ];
    }
