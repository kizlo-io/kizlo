...
export type WPK_Category = WP_EndpointData<"kizlo.taxonomies.category.retrieve">

/** A category as it appears in a list response — the same term, without the resolved SEO block. */
export type WPK_CategoryListItem = WP_EndpointData<"kizlo.taxonomies.category.list">[number]
